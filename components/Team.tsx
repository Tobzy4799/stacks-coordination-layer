  ...
  const team = [
    {
      name: "Azeez Muizz",
      role: "Lead Builder",
      bio: "Building at the intersection of Web3 and human coordination. UX researcher focused on behavioral infrastructure for blockchain systems. Been in Web3 for 6 years - started trying to build stuff, realized I’m better at understanding why people struggle to use it. I study how users actually interact with protocols (not how we think they do) and help builders design safer systems from the ground up..",
      links: {
    ...
    <section id="team" className="py-24 px-4 bg-gray-950/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-800 text-sm mb-4">Supported by</p>
          <div className="flex flex-wrap justify-center gap-6 items-center">
            <div className="text-gray-100 text-sm">Stacks Ecosystem</div>
            <div className="text-gray-600">•</div>
            <div className="text-gray-100 text-sm">BlockBoard Research</div>
            <div className="text-gray-600">•</div>
            <div className="text-gray-100 text-sm">Open Source</div>
          </div>
        </div>
      </div>
    </section>
