    ...
    <section id="contact" className="py-24 px-4 bg-gray-950/50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-100 text-lg max-w-2xl mx-auto mb-12">
          We are looking for early pilot participants, Stacks builders who want to help shape the
          coordination layer. Reach out to discuss collaboration.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-gray-100 text-sm">Hello.muzeez@gmail.com</p>
          </a>

          <a
            href="https://x.com/0xmuizz"
            target="_blank"
          ...
          >
            ...
            <p className="text-gray-100 text-sm">@0xmuizz</p>
          </a>

          <a
            href="https://discord.gg/xRuPct8w"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gray-900/50 backdrop-blur-lg rounded-xl p-6 card-glow hover:border-orange-500/40 transition-all duration-300 group"
          >
            ...
            <p className="text-gray-100 text-sm">Join our community</p>
          </a>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-100 text-sm">MIT Licensed</p>
              </div>
            </div>
            <a
              href="https://github.com/tobzy4799/stacks-coordination-layer"
              target="_blank"
              rel="noopener noreferrer"
